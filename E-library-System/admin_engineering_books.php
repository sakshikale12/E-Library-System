...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<h2>List Of Engineering Books</h2>
	<?php

		if(isset($_POST['submit']))
		{
			$q=mysqli_query($db,"SELECT * from engineering_books where name like '%$_POST[search]%' ");
		...
		{
			$res=mysqli_query($db,"SELECT * FROM `engineering_books` ORDER BY `engineering_books`.`name` ASC;");
