...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<h2>List Of Fiction Books</h2>
	<?php

		if(isset($_POST['submit']))
		{
			$q=mysqli_query($db,"SELECT * from fiction where name like '%$_POST[search]%' ");
		...
		{
			$res=mysqli_query($db,"SELECT * FROM `fiction` ORDER BY `fiction`.`name` ASC;");
