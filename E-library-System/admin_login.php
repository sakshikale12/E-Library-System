   ...
   <br>
    <div class="box1">
      ...
      <p style="color: white; padding-left: 15px;">
        <br><br>
        <a style="color:white;" href="admin_update_password.php">Forgot password?</a> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
      </p>
    </form>
    </div>
  </div>
...
<?php
    ...
    {
      $count=0;
      $res=mysqli_query($db,"SELECT * FROM `admins` WHERE username='$_POST[username]' && password='$_POST[password]';");
      ...
      else
      {
        ...
        ?>
          <script type="text/javascript">
            window.location="admin_home_index.php"
          </script>
        <?php
      }
    }
