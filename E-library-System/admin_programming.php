...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<h2>List Of Programming Books</h2>
	<?php

		if(isset($_POST['submit']))
		{
			$q=mysqli_query($db,"SELECT * from programming where name like '%$_POST[search]%' ");
		...
		{
			$res=mysqli_query($db,"SELECT * FROM `programming` ORDER BY `programming`.`name` ASC;");
