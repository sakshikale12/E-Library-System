...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<h2>List Of Suspense Books</h2>
	<?php

		if(isset($_POST['submit']))
		{
			$q=mysqli_query($db,"SELECT * from suspense where name like '%$_POST[search]%' ");
		...
		{
			$res=mysqli_query($db,"SELECT * FROM `suspense` ORDER BY `suspense`.`name` ASC;");
