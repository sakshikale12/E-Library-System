...
<div id="main">
  ...
  <div class="container" style="text-align: center;">
    <h2 style="color:black; font-family: times new roman; text-align: center; font-size:45px; padding-bottom:50px;"><b>Add New Enginneering Book</b></h2>
...
<?php
    if(isset($_POST['submit']))
    {
      if(isset($_SESSION['login_user']))
      {
        mysqli_query($db,"INSERT INTO engineering_books VALUES ('$_POST[bid]', '$_POST[name]', '$_POST[authors]', '$_POST[edition]', '$_POST[link]') ;");
        ?>
