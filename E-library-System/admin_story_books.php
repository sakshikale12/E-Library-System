...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<h2>List Of Story Books</h2>
	<?php

		if(isset($_POST['submit']))
		{
			$q=mysqli_query($db,"SELECT * from story_books where name like '%$_POST[search]%' ");
		...
		{
			$res=mysqli_query($db,"SELECT * FROM `story_books` ORDER BY `story_books`.`name` ASC;");
